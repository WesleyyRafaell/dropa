	...
	return (
		<div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
			...
			<form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
				...
				>
					{isPending ? 'Conta sendo criada...' : 'Criar conta'}
			...
			<div className="grid grid-cols-1 gap-4 mb-6">
				<a href="/login/google" className="w-full">
					<button className="flex cursor-pointer w-full items-center justify-center gap-2 bg-white/20 hover:bg-white/30 text-white py-3 px-4 rounded-lg transition-all">
